    ...
    <div className="flex-1 overflow-auto p-4 md:p-10">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-end mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Tracking across 12 active accounts</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 flex flex-col justify-between h-40">
          <div>
            <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase mb-1">Total Invested</p>
            <h3 className="text-2xl lg:text-3xl font-bold text-[#0F172A] dark:text-gray-200">$312,000.00</h3>
          </div>
          <div className="flex justify-between items-end">
            <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase">Cash Basis</p>
        ...
        <div className="bg-white dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 flex flex-col justify-between h-40">
          <div>
            <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase mb-1">Portfolio XIRR</p>
            <h3 className="text-2xl lg:text-3xl font-bold text-[#991B1B] dark:text-emerald-500">14.82%</h3>
          </div>
          <div className="flex justify-between items-end">
            <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase">Annualized</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#F0F5FF] dark:bg-[#1A2235] p-6 rounded-2xl shadow-sm border border-blue-50 dark:border-blue-900/30 flex flex-col justify-between">
          ...
          <div className="space-y-3 mb-6">
            <div className="bg-white dark:bg-[#1E1E1E] p-4 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 flex justify-between items-center">
              <div>
                <p className="text-xs font-bold text-[#0F172A] dark:text-gray-200 mb-0.5">Vanguard 500 SIP</p>
                <p className="text-[9px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest">Next: Oct 05</p>
              </div>
            ...
            <div className="bg-white dark:bg-[#1E1E1E] p-4 rounded-xl shadow-sm border border-gray-100 dark:border-white/5 flex justify-between items-center">
              <div>
                ...
                <p className="text-[9px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest">Next: Oct 12</p>
              </div>
              <div className="text-right">
      ...
      <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 overflow-hidden">
        <div className="p-6 flex flex-col sm:flex-row justify-between sm:items-center border-b border-gray-50 dark:border-white/5 gap-4">
          ...
          <div className="flex space-x-3">
            <div className="relative">
              <select className="pl-3 pr-8 py-2 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/10 text-[#0F172A] dark:text-gray-200 text-[10px] font-bold rounded-md appearance-none focus:outline-none focus:border-[#0A3D8B] shadow-sm">
            ...
            <button className="flex items-center justify-center px-2 py-2 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/10 rounded-md shadow-sm text-gray-400 hover:text-[#0F172A] dark:hover:text-gray-200">
          ...
          <table className="w-full text-left min-w-[900px]">
            <thead>
              <tr className="border-b border-gray-50 dark:border-white/5 bg-[#F8FAFC] dark:bg-[#121212]">
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Asset Name</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">Current Value</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">1-Day Change</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">Total Gain</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center">Goal Link</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center">Action</th>
              </tr>
            </thead>
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-5 flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] text-gray-400 dark:text-gray-500 font-bold tracking-widest uppercase mt-0.5">{item.type}</p>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5 text-right">
                      <p className={`text-xs font-bold ${item.dayChangeType === 'positive' ? 'text-emerald-600 dark:text-emerald-400' : item.dayChangeType === 'negative' ? 'text-red-600 dark:text-red-400' : 'text-gray-500 dark:text-gray-400'}`}>
                        {item.dayChange}
                      </p>
                    </td>
                    <td className="px-6 py-5 text-right">
                      ...
                      <p className="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-0.5">ROI: {item.roi}</p>
                    </td>
                    <td className="px-6 py-5 text-center">
                      <span className="bg-[#F0F5FF] dark:bg-[#121212] text-[#0A3D8B] dark:text-gray-400 border dark:border-white/10 text-[8px] font-bold px-2.5 py-1.5 rounded-full uppercase tracking-widest whitespace-nowrap">
                        {item.goal}
                      </span>
                    </td>
                    <td className="px-6 py-5 text-center">
                      <button className="text-gray-400 dark:text-gray-500 hover:text-[#0A3D8B] dark:hover:text-gray-300 transition-colors">
        ...
        <div className="bg-white dark:bg-[#1E1E1E] border-t border-gray-50 dark:border-white/5 p-4 text-center">
          <button className="text-[9px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase hover:text-[#0A3D8B] dark:hover:text-gray-300 flex items-center justify-center w-full">
