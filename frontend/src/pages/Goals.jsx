    ...
    <div className="flex-1 overflow-auto p-4 md:p-10">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-end mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Surgical precision in your fiscal reporting cycle.</p>
        </div>
        <div className="flex space-x-3">
          ...
          <button className="flex items-center px-4 py-2 bg-white dark:bg-[#1E1E1E] border border-gray-200 dark:border-white/10 text-[#0F172A] dark:text-gray-200 rounded-lg text-xs font-semibold hover:bg-gray-50 dark:hover:bg-[#2A2A2A] transition-colors shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-[10px] font-bold text-gray-500 dark:text-gray-400 tracking-widest uppercase">Spending By Category</h3>
            <PieChart className="w-4 h-4 text-gray-300 dark:text-gray-600" />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="relative w-32 h-32">
              <svg viewBox="0 0 36 36" className="w-full h-full transform -rotate-90">
                <circle cx="18" cy="18" r="15.9155" fill="transparent" stroke="#E5E7EB" className="dark:stroke-[#121212]" strokeWidth="4"></circle>
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center mt-1">
                <span className="block text-[8px] font-bold text-gray-400 dark:text-gray-500 tracking-widest uppercase">Total</span>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-xs w-24">
                <div className="flex items-center"><div className="w-2 h-2 rounded-full bg-[#1E3A8A] dark:bg-gray-400 mr-2"></div><span className="text-gray-600 dark:text-gray-400">Housing</span></div>
                <span className="font-bold text-[#0F172A] dark:text-gray-200">45%</span>
              </div>
              <div className="flex items-center justify-between text-xs w-24">
                <div className="flex items-center"><div className="w-2 h-2 rounded-full bg-[#3B82F6] dark:bg-gray-500 mr-2"></div><span className="text-gray-600 dark:text-gray-400">Lifestyle</span></div>
                <span className="font-bold text-[#0F172A] dark:text-gray-200">25%</span>
              </div>
              <div className="flex items-center justify-between text-xs w-24">
                <div className="flex items-center"><div className="w-2 h-2 rounded-full bg-[#7F1D1D] dark:bg-gray-600 mr-2"></div><span className="text-gray-600 dark:text-gray-400">Subs</span></div>
        ...
        <div className="bg-[#F8FAFC] dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 flex flex-col justify-between">
          <h3 className="text-[10px] font-bold text-gray-500 dark:text-gray-400 tracking-widest uppercase mb-4">Efficiency Ratio</h3>
          ...
          <div className="w-full h-2 bg-gray-200 dark:bg-[#121212] rounded-full overflow-hidden mb-6">
            <div className="h-full bg-[#1E3A8A] dark:bg-gray-400 w-[72%] rounded-full"></div>
          </div>
          <div className="bg-white dark:bg-[#2A2A2A] p-4 rounded-xl border border-gray-100 dark:border-white/5 flex-1 flex items-center shadow-sm">
            <div>
        ...
        <div className="bg-white dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5">
          <div className="flex justify-between items-start mb-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg bg-orange-50 dark:bg-gray-800 flex items-center justify-center text-orange-500 dark:text-gray-300">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-[11px]">
                <div className="flex items-center text-gray-500 dark:text-gray-400"><div className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-500 mr-3"></div>Oct 24, 2023</div>
                <span className="font-bold text-[#0F172A] dark:text-gray-200">-$28.12</span>
              </div>
              <div className="flex justify-between items-center text-[11px]">
                <div className="flex items-center text-gray-500 dark:text-gray-400"><div className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-500 mr-3"></div>Oct 21, 2023</div>
      ...
      <div className="bg-white dark:bg-[#1E1E1E] p-6 md:p-8 rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 mb-8">
        <div className="flex flex-col md:flex-row justify-between md:items-end mb-8 gap-4">
          <div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 text-[9px] font-bold px-2 py-1 rounded uppercase tracking-wider">Pending</span>
          </div>
        </div>
        ...
        <div className="flex overflow-x-auto pb-4 gap-8 md:justify-between hide-scrollbar">
          <div className="min-w-fit flex flex-col">
            ...
            <span className="bg-[#F0F5FF] dark:bg-[#121212] text-[#1E3A8A] dark:text-gray-400 text-[7px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider w-fit border dark:border-white/5">SAAS</span>
          </div>
          <div className="min-w-fit flex flex-col">
            ...
            <span className="bg-blue-50 dark:bg-[#121212] text-blue-600 dark:text-gray-400 border border-blue-100 dark:border-white/5 text-[7px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider w-fit">FIXED</span>
          </div>
          <div className="min-w-fit flex flex-col">
            ...
            <div className="w-2 h-2 rounded-full bg-gray-300 dark:bg-gray-600 mb-2"></div>
            <p className="text-xs font-bold text-[#0F172A] dark:text-gray-200 mb-2">$19.99</p>
            <span className="bg-orange-50 dark:bg-[#121212] text-orange-700 dark:text-gray-400 border dark:border-white/5 text-[7px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider w-fit">LIFESTYLE</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-sm border border-gray-50 dark:border-white/5 overflow-hidden mb-8">
        <div className="p-6 flex flex-col sm:flex-row justify-between sm:items-center border-b border-gray-50 dark:border-white/5 gap-4">
          ...
          <div className="flex space-x-3">
            <button className="flex items-center justify-between px-3 py-1.5 bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/10 rounded-md text-[10px] font-bold text-[#0F172A] dark:text-gray-200 w-32 shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left min-w-[800px]">
            <thead>
              <tr className="bg-white dark:bg-[#121212] border-b border-gray-50 dark:border-white/5">
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Reference</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Merchant & Category</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Date</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">Volume</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center">Status</th>
                <th className="px-6 py-4 text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center">Control</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50 dark:divide-white/5">
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                ...
                <td className="px-6 py-5 flex items-center space-x-4">
                  <div className="w-8 h-8 rounded-full bg-[#F0F5FF] dark:bg-gray-800 flex items-center justify-center text-[#1E3A8A] dark:text-gray-300 shrink-0">
                    <Cloud className="w-3.5 h-3.5" />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-[#0F172A] dark:text-gray-200">DigitalOcean Holdings</p>
                    <p className="text-[9px] text-gray-500 dark:text-gray-500">Subscriptions</p>
                  </div>
                </td>
                <td className="px-6 py-5 text-[11px] font-medium text-gray-600 dark:text-gray-400">Oct 28, 2023</td>
                <td className="px-6 py-5 text-xs font-bold text-[#991B1B] dark:text-red-400 text-right">-$48.00</td>
                <td className="px-6 py-5 text-center">
                  <span className="bg-[#3A2218] dark:bg-gray-800 text-white dark:text-gray-300 text-[8px] font-bold px-2 py-1.5 rounded uppercase tracking-widest">Settled</span>
                </td>
                <td className="px-6 py-5 text-center">
                  <button className="text-gray-300 dark:text-gray-500 hover:text-[#1E3A8A] dark:hover:text-gray-300 transition-colors"><ExternalLink className="w-4 h-4 mx-auto" /></button>
                </td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="bg-[#F8FAFC] dark:bg-[#1E1E1E] border-t border-gray-50 dark:border-white/5 p-4 text-center">
